...
EMIEL_MESSAGES = [
    "Emiel was hiding there and 🍇 you.",
    "Emiel stabbed you and ran away.",
    "Emiel fucked you behind the minefield.",
    "You found Emiel. Unfortunately, he found your money too.",
    "Emiel raped you and disappeared."
]
...
class MinesCog(commands.Cog):
    ...
    # The alias has been removed so it doesn't conflict with your .mine command
    @commands.command()
